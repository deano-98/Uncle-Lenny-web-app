...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "school bus hire Harare",
    "school transport services Zimbabwe",
    "school transport solutions",
    "school bus services Harare",
    "school transport company Zimbabwe",
    "school bus fleet Harare",
    "school transport provider Zimbabwe",
    "school bus hire services",
    "school transport for parents",
    "school bus services for schools",
    "school transport solutions Harare",
    "buses for hire Harare",
    "transport for hire"
  ],
  openGraph: {
